...
function VLib:Window(textgame)
	...
	MainFrame.Size = UDim2.new(0, 392, 0, 252)
	...
	LeftFrame.Size = UDim2.new(0, 118, 0, 252)
	...
	MainTitle.Size = UDim2.new(0, 44, 0, 12)
	...
	GameTitle.Size = UDim2.new(0, 44, 0, 12)
	...
	TabHolder.Size = UDim2.new(0, 101, 0, 197)
	...
	RainbowLine.Size = UDim2.new(0, 392, 0, 0)
	...
	DragFrame.Size = UDim2.new(0, 273, 0, 12)
	...
	function Tabs:Tab(text)
		...
		Container.Size = UDim2.new(0, 262, 0, 229)
		...
		function ContainerItems:Button(text, callback)
			...
			Button.Size = UDim2.new(0, 257, 0, 17)
		...
		function ContainerItems:Toggle(text, callback)
			...
			Toggle.Size = UDim2.new(0, 257, 0, 17)
			...
			Title.Size = UDim2.new(0, 122, 0, 17)
			Title.Font = Enum.Font.Gotham
			Title.Text = text
			Title.TextColor3 = Color3.fromRGB(255, 255, 255)
			Title.TextSize = 14.000
			...
			ToggleFrame.Size = UDim2.new(0, 22, 0, 12)
			...
			ToggleFrameRainbow.Size = UDim2.new(0, 22, 0, 12)
			...
			ToggleDot.Size = UDim2.new(0, 9, 0, 9)
		...
		function ContainerItems:Slider(text, min, max, start, callback) 
			...
			Slider.Size = UDim2.new(0, 257, 0, 31)
			...
			SliderFrame.Size = UDim2.new(0, 245, 0, 6)
			...
			Value.Size = UDim2.new(0, 122, 0, 17)
		...
		function ContainerItems:Dropdown(text, list, callback)
			...
			Dropdown.Size = UDim2.new(0, 257, 0, 17)
			...
			DropdownFrame.Size = UDim2.new(0, 257, 0, 0)
			...
			DropdownHolder.Size = UDim2.new(0, 246, 0, 0)
			...
			Dropdown.MouseButton1Click:Connect(
				function()
					if DropToggled == false then
						...
						repeat
							wait()
						until DropdownFrame.Size == UDim2.new(0, 257, 0, 0)
						DropdownFrame.Visible = false
						Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
					end
			...
			for i, v in next, list do
				...
				Item.Size = UDim2.new(0, 244, 0, 15)
		...
		function ContainerItems:Colorpicker(text, preset, callback)
			...
			Colorpicker.Size = UDim2.new(0, 257, 0, 17)
			...
			BoxColor.Size = UDim2.new(0, 22, 0, 12)
			...
			ColorpickerFrame.Size = UDim2.new(0, 257, 0, 0)
			...
			Hue.Position = UDim2.new(0, 133, 0, 5)
			Hue.Size = UDim2.new(0, 16, 0, 51)
			...
			HueSelection.Size = UDim2.new(0, 11, 0, 11)
			HueSelection.Image = "http://www.roblox.com/asset/?id=4805639000"

			Color.Name = "Color"
			Color.Parent = ColorpickerFrame
			Color.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
			Color.Position = UDim2.new(0, 5, 0, 5)
			Color.Size = UDim2.new(0, 124, 0, 51)
			Color.ZIndex = 10
			...
			ColorSelection.Size = UDim2.new(0, 11, 0, 11)
			...
			Confirm.Size = UDim2.new(0, 92, 0, 16)
			...
			RainbowToggle.Size = UDim2.new(0, 92, 0, 16)
			...
			RainbowTitle.Size = UDim2.new(0, 18, 0, 16)
			...
			RainbowToggleFrame.Size = UDim2.new(0, 22, 0, 12)
			...
			RainbowToggleFrameRainbow.Size = UDim2.new(0, 22, 0, 12)
			...
			RainbowToggleDot.Size = UDim2.new(0, 9, 0, 9)
			...
			Colorpicker.MouseButton1Click:Connect(
				function()
					if ColorPickerToggled == false then
						...
						repeat
							wait()
						until ColorpickerFrame.Size == UDim2.new(0, 257, 0, 64)
						Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
					else
						ColorPickerToggled = not ColorPickerToggled
						ColorpickerFrame:TweenSize(
						...
						repeat
							wait()
						until ColorpickerFrame.Size == UDim2.new(0, 257, 0, 0)
						ColorpickerFrame.Visible = false
						Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
					end
				end
		...
		function ContainerItems:Textbox(text, disapper, callback)
			...
			Textbox.Size = UDim2.new(0, 257, 0, 17)
			...
			TextboxFrame.Size = UDim2.new(0, 85, 0, 12)
			...
			TextBox.Size = UDim2.new(0, 85, 0, 12)
			TextBox.Font = Enum.Font.Gotham
			TextBox.Text = ""
			TextBox.TextColor3 = Color3.fromRGB(255, 255, 255)
			TextBox.TextSize = 14.000
